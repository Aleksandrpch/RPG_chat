          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                color: _selectedProvider == 'openrouter' ? Colors.blue.withOpacity(0.1) : Colors.transparent,
            ...
            Container(
              decoration: BoxDecoration(
                color: _selectedProvider == 'vsegpt' ? Colors.blue.withOpacity(0.1) : Colors.transparent,
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
