...
class _ChatScreenState extends State<ChatScreen> {
  ...
  // TODO: позже добавим экран ачивок
  ScaffoldMessenger.of(context).showSnackBar(
    SnackBar(content: Text('Скоро здесь будут ключевые события')),
  );
  }

  void _openInventory(BuildContext context) {
  // TODO: позже добавим инвентарь
  ScaffoldMessenger.of(context).showSnackBar(
    SnackBar(content: Text('Скоро здесь будет инвентарь')),
  );
  }
